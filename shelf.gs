...
function readShelf_(req) {
  ...
  var system = [
    ...
    '  of them are whisky throws away the whole photograph. Put the kind',
    '  in sub when you can see it: rum, vodka, gin, mezcal, tequila,',
    '  liqueur, brandy, or one of the whisky categories.',
    '- Skip only what is not a bottle of something: empty glasses,',
    '  decanters you cannot identify, and boxes.',
    '',
